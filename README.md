...
빈티지 신문 톤의 읽기 전용 개인 웹페이지(공부 정리 + 포트폴리오)를 Vercel에 올리기 위한 Next.js 프로젝트입니다. 디자인과 기능은 기존 아티팩트와 동일하며, 배포를 위해 **데이터 읽기**와 **AI 검색** 두 군데만 외부 호스팅에 맞게 바꿨습니다.
...
- 파일을 고치고 다시 push하면 Vercel이 자동으로 새로 빌드 및 배포합니다.
